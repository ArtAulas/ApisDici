...
'''
Se estiver usando o IDLE (editor que vem embutido no python) rode o codigo apertando F5

Se você digitar agenda_exemplo['maria'],
deverá ver o telefone da maria

Sempre que eu falar pra você dar F5 no IDLE, temos uma alternativa pro VSCode:

abrir o terminal em baixo, e usar python -i dicionarios.py
Quando for fazer de novo, rodar exit() no python e rodar
python -i dicionarios.py de novo
'''
...
'''
Rode o codigo no IDLE apertando F5 (ou use a alternativa do VSCode abaixo)
